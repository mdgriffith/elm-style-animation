...
update action model =
  case action of
    RotateWidget i ->
      let 
        widgets = 
          Style.queue -- queue up this animation 
    ...
    ChangeColors i ->
       let 
          widgets = 
            Style.animate -- animate is used to interrupt whatever current animation
...
box i widget = 
   let
    ...
    in
      div [ style (boxStyle ++ Style.render widget.style) 
