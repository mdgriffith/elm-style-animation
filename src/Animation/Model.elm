...
-}
step : Time.Posix -> List Property -> List Property
step dt props =
    let
        stepProp property =
            case property of
...
stepPath : Time.Posix -> PathCommand -> PathCommand
stepPath dt cmd =
    let
        stepCoords coords =
            List.map
...
{-| -}
stepInterpolation : Time.Posix -> Motion -> Motion
stepInterpolation posix motion =
    let
        dtms =
            toFloat <|
